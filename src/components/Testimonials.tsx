      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((item, index) => (
            <div
              key={index}
              className="bg-[var(--bg-surface)] backdrop-blur-sm border border-[oklch(90%_0.012_349)] dark:border-white/10 rounded-2xl p-6 transition transform hover:scale-105"
            >
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">&ldquo;{item.quote}&rdquo;</p>
