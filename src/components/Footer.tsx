...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-[oklch(93%_0.014_349)] via-[oklch(91%_0.018_349)] to-[oklch(93%_0.014_349)] dark:from-[oklch(13%_0.022_349)] dark:via-[oklch(16%_0.025_349)] dark:to-[oklch(13%_0.022_349)] border-t border-[oklch(88%_0.014_349)] dark:border-white/10">
      ...
      <div className="relative z-10 container mx-auto px-6 py-16">
            ...
            <div className="flex gap-6 mt-6">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`text-gray-700 dark:text-white ${social.color} transition duration-300`}
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-gray-600 dark:text-gray-300 hover:text-purple-400 transition-colors duration-300 flex items-center group"
                  >
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[oklch(88%_0.014_349)] dark:border-white/10 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-500 dark:text-gray-400 text-sm">
              © {currentYear} WebDev Pro. All rights reserved.
            </div>
            <div className="flex space-x-6 text-sm">
              <a href="/privacy-policy" className="text-sm text-gray-500 dark:text-gray-400 hover:text-purple-400">
                Privacy Policy
              </a>
              <a href="/terms-of-use" className="text-sm text-gray-500 dark:text-gray-400 hover:text-purple-400">
                Terms of Service
              </a>

              <a href="/cookies-policy" className="text-gray-500 dark:text-gray-400 hover:text-purple-400 transition-colors duration-300">
                Cookie Policy
              </a>
            </div>
          </div>
